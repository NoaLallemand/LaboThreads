...
void FctThreadMasterTerminaison(void*);
...
int main()
{
    ...
    pthread_cancel(HandlerthreadMaster);
...
void* threadMaster(void*)
{
    ...
    pthread_cleanup_push(FctThreadMasterTerminaison, NULL);
...
void FctThreadMasterTerminaison(void*)
{
    printf("\nDebut de la fonction de terminaison du thread Master: Identite = %d\n", pthread_self());
}
